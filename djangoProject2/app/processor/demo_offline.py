...
class DemoOffline(IO):
    ...
    def start(self):
        ...
        return response,voting_label_name
    ...
    def pose_estimation(self):
        ...
        params = dict(model_folder='app/models', model_pose='COCO',net_resolution='320x176')
    ...
    def get_parser(add_help=False):
        ...
        parser.set_defaults(
            config='app/config/st_gcn/kinetics-skeleton/demo_offline.yaml')
